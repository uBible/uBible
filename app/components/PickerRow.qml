        ...
        Picker {
            ...
            onSelectedIndexChanged: {
                if (pickerModel && !pickerModel.resetting) {
                    pickerModel.selectedIndex = selectedIndex
                }
            }
            ...
            function resetPicker() {
                ...
                print(pickerName, selectedIndex, pickerModel.count)
                pickerModel.resetting = true
                positionViewAtIndex(pickerModel.indexOf(), PathView.Center);
                pickerModel.resetting = false
            }

            Timer {
                interval: 10
                running: true
                onTriggered: unitPicker.resetPicker()
            }
